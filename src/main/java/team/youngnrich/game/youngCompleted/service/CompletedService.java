package team.youngnrich.game.youngCompleted.service;
...
import team.youngnrich.game.youngCompleted.dto.response.RecordResponseDto;
import team.youngnrich.game.youngCompleted.repository.CompletedRepository;
...
public class CompletedService {
    ...
    public String clear(Authentication authentication, ClearRequestDto requestDto) throws AuthenticationException {
        ...
        YoungCompleted completed = YoungCompleted.builder()
        ...
        // 완료기록 생성
        YoungCompleted savedCompleted = completedRepository.save(completed);
        // 최고기록 갱신
    ...
    public RecordListResponseDto getMyRecord(Authentication authentication) {
        List<YoungCompleted> recordList= findAllByKakaoId(authentication.getName());
        List<RecordResponseDto> dtoList = new ArrayList<>();
        for(YoungCompleted c : recordList)
    ...
    @Transactional(readOnly = true)
    private List<YoungCompleted> findAllByKakaoId(String kakaoId) {
